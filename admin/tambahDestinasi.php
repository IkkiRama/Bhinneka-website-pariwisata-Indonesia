...
<head>
	...
	<title>Tambah Destinasi | Bhinneka</title>
</head>
<body>
	<h1>Tambah Daftar Destinasi</h1>
	...
	<form method="post">
		<ul>
			<li>
				<label for="provinsi">Provinsi Destinasi : </label>
...
if (isset($_POST['tambah'])) {
	...
	$conn->query("INSERT INTO destinasi VALUES(null, '$provinsi', '$nama')");
